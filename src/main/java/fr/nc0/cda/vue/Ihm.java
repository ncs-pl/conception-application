...
package main.java.fr.nc0.cda.vue;
...
public class Ihm {
    ...
    public int[] selectAlumette(String joueurNom){
        ...
        while(enCours){
            System.out.print(joueurNom + " : à vous de jouer un coup (sous la forme 'tas allumettes') : ");
            if(scanner.hasNextInt()){
    ...
    public boolean finPartie(String nomGagnant, String nomPerdant, int nbrVictoireGagnant, int nbrVictoirePerdant){
    ...
    public void afficheGagnant(String nomGagnant, String nomPerdant, int nbrVictoireGagnant, int nbrVictoirePerdant, boolean exaequo){
        etatNbrVictoire(nomGagnant, nomPerdant, nbrVictoireGagnant, nbrVictoirePerdant);
        if(exaequo){
            System.out.println("Ex-aequo ! "+ nomGagnant + " et " + nomPerdant + " ont gagnés autant de partie !");
        } else {
            System.out.println(nomGagnant + " est le grand gagnant !");
        }
    }

    private void etatNbrVictoire(String nomJoueur1, String nomJoueur2, int nbrVictoireJoueur1, int nbrVictoireJoueur2){
        System.out.println("Etat des scores : " + nomJoueur1 + " -> " + nbrVictoireJoueur1 + " V | " +
            nomJoueur2 + " -> " + nbrVictoireJoueur2 + " V");
    }
